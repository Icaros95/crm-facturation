...
z"/>
        ...
        {/*  CONDICIONAR / FUNCIONAMIENTO - vista done */}
              Sign in
            </Typography>
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
              ...
              <Button
                ...
                fullWidth
                variant="contained"
                sx={{ mt: 3, mb: 2, bgcolor: teal[500], '&:hover': { bgcolor: teal[600]} }}
              >
                Sign In
              </Button>
              <Grid container>
                <Grid item xs>
                  <Link href="#" variant="body2" sx={{ color: teal[400] }}>
                    Forgot password?
                  </Link>
                </Grid>
                <Grid item>
                  <Link href="/signUp" variant="body2" sx={{ color: teal[400] }}> {/* renderizado a pagina de registro sencillo */}
