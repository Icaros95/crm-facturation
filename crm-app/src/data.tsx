...
import DahsboardIcon from '@mui/icons-material/HomeOutlined';
import CustomersIcon from '@mui/icons-material/PermIdentity';
import ItemsIcon from '@mui/icons-material/StarOutlineOutlined';
import FileDescriptIcon from '@mui/icons-material/DescriptionOutlined';
import EstimatesIcon from '@mui/icons-material/InsertDriveFileOutlined';


const data = {
    mainListItems: [
        { text: 'Dashboard', icon: <DahsboardIcon />, link: '/'},
        { text: 'Customers', icon: <CustomersIcon />, link: '/customers'},
        { text: 'Items', icon: <ItemsIcon />, link: '/items'},
    ],    
    secondaryListItems: [    
        { text: 'Estimates', icon: <EstimatesIcon />, link: '/estimates'},
        { text: 'Invoices', icon: <FileDescriptIcon />, link: '/invoices'},
        { text: 'Payments', icon: <FileDescriptIcon />, link: '/payments'},
        { text: 'Expenses', icon: <FileDescriptIcon />, link: '/expenses'}
    ],
    tablePage: {
        items: [
